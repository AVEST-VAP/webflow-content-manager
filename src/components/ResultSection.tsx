  ...
  return (
    <div className="section">
      <h2 className="section-title">
        {hasErrors ? 'Deployment completed with errors' : 'Deployment successful'}
      </h2>
      ...
      {isMultiPage && report.multiPageReports ? (
        <>
          <h3 className="text-sm mb-4" style={{ fontWeight: '600' }}>Results by page</h3>
        ...
        <div className="error-box mb-4">
          ...
          {report.errors.length > MAX_DISPLAYED_WARNINGS ? (
            <div style={{ marginTop: '8px', opacity: 0.8 }}>
              ... and {report.errors.length - MAX_DISPLAYED_WARNINGS} more
            </div>
          ) : null}
        </div>
      ) : null}
      ...
      {hasWarnings ? (
        <div style={{
          ...
          {report.warnings.length > MAX_DISPLAYED_WARNINGS ? (
            <div style={{ marginTop: '8px', opacity: 0.8 }}>
              ... and {report.warnings.length - MAX_DISPLAYED_WARNINGS} more
            </div>
          ) : null}
        </div>
      ) : null}
